...
module riscv_formal_monitor_rv32imc (
  ...
  wire ch0_rvfi_mem_extamo = rvfi_mem_extamo[0];
	...
	/*probably wrong*/
  wire ch0_spec_valid /*= ch0_rvfi_valid*/;
  wire ch0_spec_trap /*= ch0_rvfi_trap*/;
  wire [4:0] ch0_spec_rs1_addr /*= ch0_rvfi_rs1_addr*/;
  wire [4:0] ch0_spec_rs2_addr /*= ch0_rvfi_rs2_addr*/;
  wire [4:0] ch0_spec_rd_addr /*= ch0_rvfi_rd_addr*/;
  wire [31:0] ch0_spec_rd_wdata /*= ch0_rvfi_rd_wdata*/;
  wire [31:0] ch0_spec_pc_wdata /*= ch0_rvfi_pc_wdata*/;
  wire [31:0] ch0_spec_mem_addr /*= ch0_rvfi_mem_addr*/;
  wire [3:0] ch0_spec_mem_rmask /*=ch0_rvfi_mem_rmask*/;
  wire [3:0] ch0_spec_mem_wmask /*= ch0_rvfi_mem_wmask*/;
  wire [31:0] ch0_spec_mem_wdata /*= ch0_rvfi_mem_wdata*/;
	/*end probably wrong*/
